...
odin build src/putting_it_together -out:build/putting_it_together.exe %odinflags% && build\putting_it_together.exe

@REM odin test tests %odinflags%

@REM odin build tests --out:build/tests.exe %ODINFLAGS% && build\tests.exe
